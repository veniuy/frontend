...
const AdminDashboard = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      // Cargar plantillas
      const templatesData = await apiClient.get("/admin/templates");
      setTemplates(templatesData.templates);

      // Cargar diseños de usuarios
      const designsData = await apiClient.get("/admin/user-designs");
  ...
  const handleUpdateUserSubscription = async (userId, newSubscription) => {
    try {
      const response = await apiClient.put(`/admin/users/${userId}/subscription`, { tipo_suscripcion: newSubscription });

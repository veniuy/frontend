  ...
  return (
    <Routes>
      ...
      <Route path="/app" element={user ? <LayoutImproved /> : <Navigate to="/login" />}>
        ...
        <Route path="guest-surveys" element={<div className="p-8"><h1 className="text-2xl font-bold">Guest Surveys - Próximamente</h1></div>} />
        ...
        <Route path="tracking" element={<div className="p-8"><h1 className="text-2xl font-bold">Tracking y Analytics - Próximamente</h1></div>} />

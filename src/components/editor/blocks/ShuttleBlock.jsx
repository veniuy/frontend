...
const ShuttleBlock = ({ block, theme, fontFamily, isSelected, onClick, previewMode }) => {
  ...
  return (
    <div 
      ...
      onClick={onClick} 
      style={{ backgroundColor: `${theme.colorPalette}05`, fontFamily }}
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        >
          <Car className="w-8 h-8" style={{ color: theme.colorPalette }} />
        </div>
        <h3 
        ...
        <p 
          ...
          style={{ color: theme.colorPalette }}
        >
          {typeof block.content === 'string' ? block.content : 'Información sobre transporte...'}
        </p>

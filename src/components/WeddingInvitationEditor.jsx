...
const WeddingInvitationEditor = ({ event }) => {
  ...
  const handleSave = async () => {
    try {
      await apiClient.updateEvent(invitation.id, invitation);
      // Puedes agregar un toast o notificación de éxito aquí
      console.log('Invitación guardada');
    } catch (error) {
      console.error('Error al guardar la invitación', error);
      // Puedes agregar un toast o notificación de error aquí
    }
  };
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button variant="outline" size="sm" className="flex items-center space-x-2" onClick={handleSave}>

...
export function DashboardEnhanced() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const userEvents = eventsResponse.data || eventsResponse.events || [];
      ...
      const calculatedStats = {
        ...
        draft_events: userEvents.filter(e => e.status === 'DRAFT').length,
        ...
        total_revenue: userEvents.reduce((sum, e) => sum + (e.payment_amount || 0), 0)
      };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {stats.confirmed_guests} confirmados
                </p>
              </CardContent>
            </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3 p-4 border rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Control total sobre el diseño</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="analytics" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {stats.confirmed_guests} de {stats.total_guests} invitados
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  De {stats.total_events} eventos totales
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Promedio por Evento</CardTitle>
                <TrendingUp className="h-4 w-4 text-purple-500" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {stats.total_events > 0 ? Math.round(stats.total_guests / stats.total_events) : 0}
                </div>
                <p className="text-xs text-muted-foreground">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Resumen de la actividad de tus eventos en los últimos meses
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-gray-500">Gráfico de analíticas</p>
          ...
          {/* Lista de eventos por rendimiento */}
          <Card>
            <CardHeader>
              <CardTitle>Rendimiento por Evento</CardTitle>
              <CardDescription>
                Estadísticas detalladas de cada evento
              </CardDescription>
            </CardHeader>
            <CardContent>
              {events.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400">Crea eventos para ver analíticas</p>
                </div>
              )}
            </CardContent>
          </Card>

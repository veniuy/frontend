              ...
              <div className="relative z-10 bg-white rounded-2xl shadow-xl p-8 max-w-md mx-auto">
                <div className="w-full h-64 bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">15 de Junio, 2024</p>
                  </div>
                </div>
              </div>
              ...
              <CardContent>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-600">5 invitaciones</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Plantillas básicas</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">RSVP incluido</span>
                  </li>
                </ul>
                <Button 
                  variant="outline" 
            ...
            <Card className="bg-white border-blue-500 relative">
              ...
              <CardContent>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Invitaciones ilimitadas</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Todas las plantillas</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Personalización avanzada</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Galería de fotos</span>
                  </li>
                </ul>
                <Button 
            ...
            <Card className="bg-white">
              ...
              <CardContent>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Todo Premium +</span>
                  </li>
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                  ...
                  <li className="flex items-center">
                    <Check className="w-5 h-5 text-green-500 mr-3" />
                    <span className="text-gray-600">Análisis detallados</span>
                  </li>
                </ul>
                <Button 
                  variant="outline" 
